...
from sim_a_splat.env.pusht.pusht_env import PushTEnv
from sim_a_splat.env.pusht.pymunk_keypoint_manager import PymunkKeypointManager
import numpy as np
...
class PushTKeypointsEnv(PushTEnv):
    def __init__(
        ...
        ws = max(self.window_size_x, self.window_size_y)
